...
from lunar_segmentation.training.train_rcnn import MaskRCNN_Trainer
...
MODEL_WEIGHTS_DIR = BASE_DIR / 'weights'           # Folder to save weights
...
if DATA_INDEX.exists():
    ...
    # If you get Out Of Memory (OOM) errors, lower the batch_size to 2 or 1.
